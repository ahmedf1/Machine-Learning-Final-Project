...
df.drop( ['School Type', 'Demographic Variable', 'Total Tested',
...
df3.to_csv("HS_Regents_Sat_Scores_2015_v2.csv")                                                                        #Export df as csv
