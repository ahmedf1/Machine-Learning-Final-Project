...
df.drop( [  'Algebra2/Trigonometry','Physical Settings/Chemistry',
            'Geometry', 'Physical Settings/Physics',
...
df3.to_csv("HS_Regents_Sat_Scores_2015MoreRows.csv")                                                                        #Export df as csv
